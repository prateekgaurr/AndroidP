...
public class MyAdapterListTwo extends RecyclerView.Adapter<MyAdapterListTwo.ViewHolder> {
    private List<String> allItems;
    private List<String> selectedList;
    private final ItemsSelectedListenerTwo listener;


    public MyAdapterListTwo(List<String> allItems, ItemsSelectedListenerTwo listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.checkBox.setOnCheckedChangeListener((buttonView, isChecked) -> {
            ...
            listener.SelectedItemsChanged(selectedList);
        });
    }
